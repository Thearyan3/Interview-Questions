...
//     }
// }
// console.log("The number of 0's in given array are :", count);
...
if (obj1.array1.length === obj2.array2.length && 
    obj1.array1.every((val, index) => val === obj2.array2[index])) {
    console.log("true");
} else {
    console.log("false");
}
